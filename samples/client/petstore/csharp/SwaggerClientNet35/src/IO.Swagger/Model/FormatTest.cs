...
namespace IO.Swagger.Model
{
        ...
        public partial class FormatTest :  IEquatable<FormatTest>
    {
        ...
        public FormatTest(int? integer = default(int?), int? int32 = default(int?), long? int64 = default(long?), decimal? number = default(decimal?), float? _float = default(float?), double? _double = default(double?), string _string = default(string), string _byte = default(string), string binary = default(string), DateTime? date = default(DateTime?), DateTime? dateTime = default(DateTime?), Guid? uuid = default(Guid?), string password = default(string))
        {
